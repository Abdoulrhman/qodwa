...
const LocaleProvider = ({ children }) => {
  const [langParam, setLangParam] = useSearchParams({
    lang: localStorage.getItem(localeText) || localeUtils.EN,
  });
  const [lang, changeLang] = useState(
    langParam.get("lang") || localStorage.getItem(localeText) || localeUtils.EN
  );
